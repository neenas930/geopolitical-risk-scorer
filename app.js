const NewsAPI = {
    async fetchHeadlines(country) {
      const url = `https://newsapi.org/v2/everything?q=${encodeURIComponent(country)}+economy+politics+currency&sortBy=publishedAt&pageSize=20&language=en&apiKey=${CONFIG.NEWS_API_KEY}`;
